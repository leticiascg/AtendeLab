window.AtendeLabApi = (() => {
    ...
    async function request(controller, action, { method = 'GET', query = {}, body = null } = {}) {
        ...
        catch { throw new Error('Resposta inválida recebida do backend.'); }
    ...
    function showAlert(id, message, type = 'success') {
        ...
        if (!element) return;
        element.innerHTML = `<div class="alert alert-${type} alert-dismissible fade show" role="alert">${escape(message)}
